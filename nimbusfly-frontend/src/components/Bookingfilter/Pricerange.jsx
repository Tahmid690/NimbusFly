...
export default function PriceRange({minprice = 0, maxprice = 1000, rangeValues = [100, 800], setRangeValues}) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-50 to-blue-100 p-3">
      <style>{`
        .range-slider {
          ...
          <div className="px-6 pb-6 space-y-6">
            ...
            <div className="bg-gradient-to-r from-sky-50 to-blue-50 p-4 rounded-xl border border-sky-100">
              <p className="text-slate-600 text-sm leading-relaxed">
                Starts from {formatCurrency(sliderMin)} - {formatCurrency(sliderMax)} against your search. 
                <span className="block text-xs text-sky-600 mt-1 font-medium">Price is subject to change</span>
              </p>
            </div>
            ...
            <div className="relative h-12 flex items-center px-2">
              ...
              <input 
                ...
                style={{ zIndex: currentRangeValues[0] > currentRangeValues[1] ? 12 : 10 }}
              />
              <input 
                type="range" 
                min={sliderMin} 
                ...
                className="range-slider" 
                style={{ zIndex: currentRangeValues[1] > currentRangeValues[0] ? 12 : 10 }}
              />
            </div>
