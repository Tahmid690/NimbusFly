...
export default function Flightscedule({
  ...
  useEffect(() => {
    setexpand(true);
    setdepart(true);
    setdept([false, false, false, false]);
    setrdept([false, false, false, false]);
    setarrt([false, false, false, false]);
    setrarrt([false, false, false, false]);
  }, [reset]);
  const handledept = (i) => {
              ...
              <div className="grid grid-cols-2 gap-2">
                {timeSlots.map((slot, i) => (
                  <button
                    ...
                    className={`flex items-center justify-center gap-2 transitio  py-2 px-3 rounded-md shadow text-sm ${
                      dept[i]
                        ? "bg-blue-500 text-white"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {timeSlots.map((slot, i) => (
                      <button
                        ...
                        className={`flex items-center justify-center gap-2 transition  py-2 px-3 rounded-md shadow text-sm ${
                          rdept[i]
                            ? "bg-blue-500 text-white"
                            : "bg-gray-100 hover:bg-blue-100"
                        }`}
