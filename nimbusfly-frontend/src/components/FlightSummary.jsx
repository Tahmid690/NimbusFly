...
const FlightSummary = ({ flight }) => {
    ...
    return (
        <>
            <div className="group relative bg-white border-sky-100 rounded-3xl mb-6 overflow-hidden shadow-lg hover:shadow-2xl hover:shadow-sky-200/60 hover:border-sky-300 transition-all duration-500">
                            ...
                            <div className="flex flex-row">
                                <div>
                                    ...
                                    <div className="text-xs lg:text-sm text-gray-600 flex items-center space-x-2">
                                        ...
                                        <span className="w-1 h-1 bg-gray-400 rounded-full"></span>
                                        <span className={`px-2 py-0.5 rounded-full text-xs font-bold ${flightData.ticket_type === 'Business'
                                                ? 'bg-amber-100 text-amber-800 border border-amber-200'
                                                : 'bg-blue-100 text-blue-800 border border-blue-200'
                                            }`}>
                                            {flightData.seatClass || 'Economy'}
                                        </span>
                                    </div>
                                </div>
                                <div >
